                    ...
                    <div class="card-body">
                        ...
                        <form>
                            ...
                            <div class="form-group required-label row">
                                ...
                                <div class="col-md-6">
                                    <input type="text" class="form-control" id="phonetic_name" v-model="customer.phonetic_name"/>
                                </div>
                            </div>
    ...
    export default {
        ...
        methods: {
            ...
            onStore: function () {
                ...
                if (!this.customer.phonetic_name) {
                    ...
                    axios.post('/api/customer', {
                        ...
                        .then((res2) => {
                            if (res2.data.result) {
                                ...
                                this.errorMessage = res2.data.errorMessage
                                this.invalid = true
                            }
                        })
                        .catch((resp) => {
