            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <table class="table table-sm" key="processes">
                        ...
                        <tbody>
                            <tr class="bg-white" v-for="(inventory, index) in search_itemCode" :key="index">
    ...
    computed: {
        search_itemCode(){
            return this.inventories.filter(inventory =>{
                return inventory.item_code.includes(this.searchItemCode) && inventory.stock_num >= this.searchStockNum
            })
        },
        // search_itemCode(){
        //     return this.inventories.filter(inventory =>{
        //         return inventory.stock_num >= this.searchStockNum
        //     })
        // },
    },
    methods:  {
